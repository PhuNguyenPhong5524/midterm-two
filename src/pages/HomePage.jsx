        ...
        "data": [
            {
                ...
                "image": "",
                "imageBanner": "../../../public/images/banner.jpg",
                "episode": "01"
            },
            {
                "id": "2",
                ...
                "image": "../../../public/images/one-piece.jpg",
                "imageBanner": "../../../public/images/banneronepiece.jpg",
                "episode": "1018"
            },
            {
                "id": "3",
                ...
                "image": "../../../public/images/boruto.jpg",
                "imageBanner": "../../../public/images/bannerboruto.jpg",
                "episode": "250"
            },
            {
                "id": "4",
                ...
                "image": "../../../public/images/spy-x-family.jpg",
                "imageBanner": "../../../public/images/bannerspyxfamily.jpg",
                "episode": "07"
            },
            {
                "id": "5",
                ...
                "image": "../../../public/images/attachontitan.png",
                "imageBanner": "../../../public/images/bannerattachontitan.jpg",
                "episode": "28"
            },
            {
                "id": "6",
                ...
                "image": "../../../public/images/capstu.jpg",
                "imageBanner": "../../../public/images/bannercaptsubasa.jpg",
                "episode": "28"
            },
            {
                "id": "7",
                ...
                "image": "../../../public/images/aoashi.jpg",
                "imageBanner": "../../../public/images/banneraoashi.jpg",
                "episode": "28"
            }
        ]
    }
...
const HomePage = () => {
    const movies = viewMovie[0]?.data;
    const [isMoviesId, setisMoviesId] = useState(viewMovie[0]?.data[0]?.id);
                ...
                {/* Box section new release */}
                    <div>
                        {/* Title */}
                            ...
                            <BoxShowMovie movies={movies} handleDetail={handleDetail} />
                    </div>
        </div>
    )
}
